    ...
    <section ref={containerRef} className="relative h-screen min-h-[700px] overflow-hidden bg-black">
      <motion.div className="absolute inset-0" style={{ y: bgY }}>
        <AnimatePresence mode="sync">
          <motion.img key={currentSlide} src={heroImages[currentSlide]} alt="Peak workshop" className="absolute inset-0 w-full h-[130%] object-cover object-center" initial={{ opacity: 0, scale: 1.1 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0 }} transition={{ duration: 2.5, ease: 'easeInOut' }} loading="eager" />
        </AnimatePresence>
      ...
      <motion.div className="relative z-20 flex flex-col justify-center h-full max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 pt-36" style={{ y: textY, opacity: textOpacity }}>
        ...
        <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.4 }} className="text-orange-400 text-xs sm:text-sm font-semibold uppercase tracking-[0.35em] mb-6" style={{ fontFamily: 'var(--font-sans)' }}>
          {hero?.badge || 'Peak Performance'}
        </motion.p>

        <div className="overflow-hidden">
          {['PEAK', 'PERFORMANCE', 'RESTORED.'].map((line, i) => (
            <motion.div key={line} initial={{ y: '120%' }} animate={{ y: 0 }} transition={{ duration: 1, delay: 0.5 + i * 0.12, ease: [0.16, 1, 0.3, 1] }}>
              <h1 className={`font-heading leading-[0.85] tracking-tighter ${line === 'PERFORMANCE' ? 'bg-gradient-to-r from-orange-400 via-orange-500 to-yellow-500 bg-clip-text text-transparent' : 'text-white'}`} style={{ fontSize: 'clamp(2.2rem, 7vw, 4.5rem)', fontWeight: line === 'PERFORMANCE' ? 900 : 200 }}>
                {line}
              </h1>
            </motion.div>
          ))}
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 1.4 }} className="flex flex-wrap gap-4 mt-8">
          ...
          <a href="tel:+263777612873" className="group inline-flex items-center gap-3 border border-white/15 text-white px-8 py-4 text-sm uppercase tracking-[0.15em] font-semibold hover:border-orange-500/40 hover:text-orange-400 transition-all duration-500" style={{ fontFamily: 'var(--font-sans)' }}>
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        <motion.div initial={{ opacity: 0, y: 30 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.8 }} className="mb-14 sm:mb-20">
          ...
          <h2 className="font-heading text-white leading-[0.92] font-bold uppercase" style={{ fontSize: 'clamp(2rem, 4.5vw, 3.5rem)' }}>
            The Peak <span className="text-orange-500">Difference</span>
          </h2>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          <motion.div initial={{ opacity: 0, x: -40 }} animate={inView ? { opacity: 1, x: 0 } : {}} transition={{ duration: 0.9 }}>
            ...
            <h2 className="font-heading text-white leading-[0.95] font-bold uppercase mb-8" style={{ fontSize: 'clamp(2rem, 5vw, 3.5rem)' }}>
              The Peak <span className="text-orange-500">Story</span>
            </h2>
            <p className="text-white/50 text-sm sm:text-base leading-relaxed mb-6 max-w-lg" style={{ fontFamily: 'var(--font-sans)' }}>
              With 181 five-star reviews and counting, Peak Panelbeaters has built a reputation as Harare's most trusted auto body repair shop. Located on Nuffield Road, our state-of-the-art facility handles everything from minor cosmetic touch-ups to major structural repairs.
            </p>
            ...
            <div className="flex gap-10 sm:gap-16">
              <div><div className="text-orange-500 font-heading text-3xl sm:text-4xl font-bold leading-none">1</div><div className="text-white/30 text-[10px] uppercase tracking-[0.2em] mt-2" style={{ fontFamily: 'var(--font-sans)' }}>Reviews</div></div>
          ...
          <motion.div initial={{ opacity: 0, x: 40 }} animate={inView ? { opacity: 1, x: 0 } : {}} transition={{ duration: 0.9, delay: 0.2 }} className="relative">
            <div className="overflow-hidden"><img src="https://images.unsplash.com/photo-1549317661-bd32c8ce0571?w=800&q=80" alt="Peak workshop" className="w-full aspect-[4/5] object-cover object-center" loading="lazy" /></div>
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          <motion.div initial={{ opacity: 0, x: 40 }} animate={inView ? { opacity: 1, x: 0 } : {}} transition={{ duration: 0.9, delay: 0.15 }}>
            <div className="w-12 h-[2px] bg-orange-500 mb-6" />
            <p className="text-orange-500/60 text-xs uppercase tracking-[0.3em] mb-3" style={{ fontFamily: 'var(--font-sans)' }}>Why Peak</p>
    ...
    <section ref={ref} className="relative py-24 sm:py-32 overflow-hidden">
      ...
      <motion.div initial={{ opacity: 0, y: 30 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.8 }} className="relative z-10 max-w-3xl mx-auto px-5 sm:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <a href="https://wa.me/263777612873" target="_blank" rel="noopener noreferrer" className="group inline-flex items-center justify-center gap-3 border border-green-500/40 text-green-400 px-8 py-4 text-sm uppercase tracking-[0.15em] font-semibold hover:bg-green-500/10 transition-all" style={{ fontFamily: 'var(--font-sans)' }}>
